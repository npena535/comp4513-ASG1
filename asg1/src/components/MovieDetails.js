      ...
      {movie && (
        <div>
          ...
          <div
            className={
              showFaves
                ? "grid md:grid-cols-3 min-h-[calc(100vh-70px)]"
                : "grid md:grid-cols-2 min-h-[calc(100vh-70px)]"
            }
          >
            ...
            <div className="mx-[50px] mt-[80px] flex flex-col gap-6 text-white">
              <div className="flex flex-row items-center gap-10">
                ...
                <div
                  className="hover:scale-[130%] transition duration-200"
